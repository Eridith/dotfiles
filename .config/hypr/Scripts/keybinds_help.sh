...
HYPR_CONF="$HOME/.config/hypr/conf/binds/hyprkeybinds.conf"

# extract the keybinding from the conf
...
CHOICE=$(printf '%s\n' "${BINDINGS[@]}" | rofi -theme ${dir}/${theme}.rasi -dmenu -i -markup-rows -p "Hyprland Keybinds:")
